 ...
 */
public class Frog extends Frogs
{
    //global variables that are used throughout all 5 frog actors
    ...
    public Frog()
    {
        ...
        score = 0;//start with 0 frogs saved
    ...
    public void mymove(){
        ...
        if ((y < 50 && y >= 0) && (x < 100 && x > 0)){
            score = score + 1;
            Greenfoot.playSound("Nice.wav");//say nice for saving frog
            getWorld().removeObjects(getWorld().getObjects(Frog.class));//Frog is safe, it can be removed from the world now
