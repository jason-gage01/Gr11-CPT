 ...
 */
public class Frog2 extends Frogs
{
    ...
    /**
     * Act - do whatever the Frog2 wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if (Frog.score == 1){
            ...
            if ((y < 50 && y >= 0) && (x < 100 && x > 0)){
                ...
                getWorld().removeObjects(getWorld().getObjects(Frog2.class));//Frog is safe, it can be removed from the world now
